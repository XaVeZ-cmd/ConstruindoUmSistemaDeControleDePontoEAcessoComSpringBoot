...
public class TipoDataService {
    ...
    public TipoData saveTipoData(TipoData tipoData){
        return tipoDataRepository.save(tipoData); //cria e retorna o objeto
    }
    ...
    public TipoData updateTipoData(TipoData tipoData){
        return tipoDataRepository.save(tipoData); //update retorna o objeto
    }

    public void deleteTipoDataById(Long idTipoData) {
